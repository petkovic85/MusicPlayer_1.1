...
public class MenuDrawerListener implements ListView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        boolean  call_interstitial_restriction = false;
        ...
        if (holder.collection != null) {
            ...
            if(mActivity != null)
            {
                if(mActivity.bannerHelper != null)
                {
                    mActivity.bannerHelper.UcitajBannere();
                }
            }
...
//                    Playlist favoritesPlaylist = DatabaseHelper.get().getLovedItemsPlaylist();


//
//                    bundle.putString(TomahawkFragment.PLAYLIST, (favoritesPlaylist).getCacheKey());
        ...
        else if (holder.id.equals(MenuDrawer.HUB_ID_MORE_APPS)) {

            call_interstitial_restriction = true;
        ...
        if(mActivity != null && !call_interstitial_restriction)
        {
            if(mActivity.interstitialHelper != null)
            {
                mActivity.interstitialHelper.CallInterstitial(mActivity, InterstitialHelper.INTERSTITIAL_ON_DRAWER_CATEGORY);
            }
        }
