...
//
//                queries.add(getPlaybackManager().getCurrentQuery());
//
//                Playlist playlist = Playlist.fromQueryList(
//                        IdGenerator.getLifetimeUniqueStringId(), "", null, queries);
//
//                playlist.setName("lista favorita");
//
//                //playlist.addQuery(getPlaybackManager().getCurrentQuery())
//
////                 playlist = Playlist.fromQueryList(
////                        IdGenerator.getLifetimeUniqueStringId(), "", null, queries);
//
//
//                CollectionManager.get().createPlaylist(playlist);
