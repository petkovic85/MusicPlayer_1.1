...
//        });
    ...
    private static void NasShare(Activity activity)
    {

        String textForShare = activity.getString(R.string.app_name) + ": https://play.google.com/store/apps/details?id=" + activity.getPackageName();
