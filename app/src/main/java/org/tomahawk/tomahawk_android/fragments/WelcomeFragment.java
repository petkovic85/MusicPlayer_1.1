        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    TextView tv = (TextView) v.findViewById(R.id.welcome_fragment_explanation_tv);
                    String originalString = getString(R.string.welcome_fragment_explanation_text);
        ...
        mPositiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mViewPager.getCurrentItem() == lastPage) {
                    ...
                    ((TomahawkMainActivity)getActivity()).CallInterstitialForSpecificLoaction((TomahawkMainActivity)getActivity(), InterstitialHelper.INTERSTITIAL_ON_TUTORIAL);
